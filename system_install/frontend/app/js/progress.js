...
fs.readFile("/tmp" + "/disk-to-install", (error, data) => {
	...
	setInterval(function() {
            ...
            if (progressText.startsWith("INSTALLATION FAILED")) {
                ...
                prog += '<p align="center" class="setup-text">Please check <b>~/Desktop/install.log</b> for details.<br>You may need to restart the installer or check your disk.</p>';
            ...
            // Verifică dacă instalarea s-a terminat (cu sau fără warnings)
                ...
                if (progressText.includes("warnings")) {
                    ...
                    prog += '<p align="center" class="setup-text">Some packages failed to install. You can close this window (ALT+F4) and reboot,<br>or check the logs: <b>~/Desktop/install.log</b> and <b>/tmp/failed_packages.log</b></p>';
                } else {
