		...
		const fs = require("fs");
            ...
            // Verifică dacă instalarea s-a terminat (cu sau fără warnings)
                ...
                if (timeValueElement && progressElement) {
                    ...
                    var prog = `
                	<li class="progress-block" style="float: none; display: flex; flex-direction: column; justify-content: center; align-items: center; width: 100%;">
                		<div class="progress-bar-wrapper" style="width: 100%; max-width: 350px; margin: 0 auto;">
                			<progress id="file" value="` + progressText + `" max="100" style="width: 100%; height: 18px;"> ` + progressText + `% </progress>
                		</div>
                		<div id="time-remaining-container" class="progress-text-under" style="width: 100%; max-width: 350px; margin: 10px auto 0 auto; min-height: 30px; display: flex; align-items: center; justify-content: center;">
